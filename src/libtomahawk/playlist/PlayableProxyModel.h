...
class DLLEXPORT PlayableProxyModel : public QSortFilterProxyModel
{
  ...
  public:
    ...
    virtual PlayableModel* sourceModel() const
    {
        return m_model;
    }
    ...
    PlayableProxyModel::PlayableItemStyle style() const
    {
        return m_style;
    }
    void setStyle( PlayableProxyModel::PlayableItemStyle style )
    {
        m_style = style;
    }
    ...
    virtual bool showOfflineResults() const
    {
        return m_showOfflineResults;
    }
    virtual void setShowOfflineResults( bool b );

    virtual bool hideDupeItems() const
    {
        return m_hideDupeItems;
    }
    virtual void setHideDupeItems( bool b );

    virtual int maxVisibleItems() const
    {
    ...
    {
        return sourceModel()->itemFromQuery( query );
    }
    virtual PlayableItem* itemFromResult( const Tomahawk::result_ptr& result ) const
    {
        return sourceModel()->itemFromResult( result );
    }
