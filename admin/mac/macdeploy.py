...
VLC_PLUGINS=[
  ...
  'access/libaccess_output_dummy_plugin.dylib',
  'access/libaccess_output_file_plugin.dylib',
  'access/libaccess_output_http_plugin.dylib',
  'access/libaccess_output_shout_plugin.dylib',
  'access/libaccess_output_udp_plugin.dylib',
